...
2. 准备一个至少8G内存，存储空间>=20G的Ubuntu系统
3. 下载gem5模拟器，阅读Getting started的building gem5章节，跟随要求在Ubuntu上进行gem5的编译
...
1. 实验提交的源代码可以正常执行，能获得5分基本分
2. 实验报告包含要求全部内容，能获得5分
